...
export class App extends React.Component {
  ...
  render() {
    const { emailIsValid, passwordIsValid, isSubmitted, firstName } =
      this.state;
        ...
        <div className="row">
          ...
          {!isSubmitted ? (
            <form onSubmit={this.handleSubmit}>
              <div className="mb-3">
                <label htmFor="firstName" className="form-label">
                  First name
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label htmFor="lastName" className="form-label">
                  Last name
                </label>
                <input
                  type="text"
            ...
            <p className="text-success text-center pt-5 fs-1">
              Bienvenue {firstName} !
            </p>
          )}
        </div>
